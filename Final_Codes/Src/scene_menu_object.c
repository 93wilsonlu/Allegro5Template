...
void drawButton(Button button) {
    ALLEGRO_BITMAP* _img =
        button.hovered_img
            ...
            : button.default_img;
    al_draw_scaled_bitmap(_img, 0, 0, al_get_bitmap_width(_img),
                          al_get_bitmap_height(_img), button.body.x,
                          button.body.y, button.body.w, button.body.h, 0);
}
